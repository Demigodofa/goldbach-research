"""Build q286 dominant-mode staircase orbit-mass-gap evidence."""
...
def main():
    ...
    payload = {
        ...
        "status_boundary": (
            "finite orbit-mass diagnostic only; synthetic extremal orbits "
            "are not prime-pair weights and no orbit-mass theorem, pointwise "
            "arithmetic theorem, or Goldbach theorem is proved"),
        ...
        "full_stage_largest_breaking_orbit_mass_row": (
            receipt["full_stage_largest_breaking_orbit_mass_row"]),
        "full_stage_smallest_breaking_orbit_mass_row": (
            receipt["full_stage_smallest_breaking_orbit_mass_row"]),
        "full_stage_largest_breaking_orbit_lift_row": (
            receipt["full_stage_largest_breaking_orbit_lift_row"]),
        "interpretation": {
            "mechanism_tested": (
                "Measure actual strict-central prime-pair mass on the "
                "reflection orbit that would break each selected row under "
                "the weak-geometry extremal construction."),
            "boundary": (
                "Finite selected-fixture mass-placement diagnostic only."),
            "remaining_theorem": (
                "Prove arithmetic limits on mass placement across q286 "
                "reflection orbits or replace this with stronger residue-"
                "weight, complement, or fixed-modulus prime-pair estimates."),
        },
