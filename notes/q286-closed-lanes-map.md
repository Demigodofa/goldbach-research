...
## 2026-09-15 q286-WBSS Four-Modulus Compression

The four-modulus route is now stronger than a stress LP repair.  The full
q286-WBSS unit coefficient modulo `10010` descends to the additive projection
span generated by total mass and moduli `[70,130,154,286]`, with relative
residual `8.752538645134008e-16`.  Dominant-only supports `[70,154,286]` fail
with residual `0.025284174723626925`.  This unit-level identity implies the
reflected target-orbit coefficient span for all `5005` even residues modulo
`10010`.

This closes one renaming concern on the coefficient side.  The open hole is
still the source-backed binary-prime projection theorem for those four moduli,
or a direct proof of the raw q286-WBSS signed witness.
